...
<html>
 ...
 <nav class="navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <button type="button" class="btn btn-warning"><a href="logout.jsp"> Sair </a></button>
  </div>
</nav>
    
    <div class="container">
         
        <button class="btn btn-warning" data-toggle="modal" data-target="#Inserir">Novo Usuário</button>
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="cadastro-form" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-warning" name="btn-salvar"> Salvar </button>
                            </div>
                            </div>
                        </form>
